...
<section class="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
  <div class="space-y-6 rounded-3xl border border-orange-100 bg-white/80 p-8 shadow-xl shadow-orange-100">
    <div class="space-y-3">
      ...
      <h1 class="text-4xl sm:text-5xl">Lesson notes that live inside the video timeline.</h1>
      <p class="text-base text-slate-600">
        Capture timestamps, collect tasks, and keep a running history of every lesson. Notes stay
  ...
  <div class="space-y-4 rounded-3xl border border-slate-200 bg-white/70 p-6 shadow-lg">
    ...
    <ul class="space-y-3 text-sm text-slate-600">
      <li>Track lessons with timestamped notes and a full edit history.</li>
